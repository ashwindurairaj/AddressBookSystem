...
class AddressBookApp {
    ...
    private get currentBook() {
        return this.currentBookName ? this.manager.getAddressBook(this.currentBookName) : null;
    }
    ...
    private createAddressBook(): void {
        ...
        try {
            ...
            console.error(`❌ ${error instanceof Error ? error.message : "Failed to create address book"}`);
        }
    }
    ...
    private selectAddressBook(): void {
        ...
        try {
            ...
            console.error(` ${error instanceof Error ? error.message : "Error accessing address book"}`);
        }
    }
